...
SetShortcuts(ShortcutsProfile) {
    ...
    ReadAndStoreHotKeyAction(ShortcutsFile, "MoveTop", "MoveTop", "^!#Home")
    ...
    ReadAndStoreHotKeyAction(ShortcutsFile, "MoveBottom", "MoveBottom", "^!#End")
    ...
    ReadAndStoreHotKeyAction(ShortcutsFile, "MoveCenter", "MoveCenter", "!#BackSpace")
...
MoveWindowToOtherDesktop(CurrentDesktop, DestinationDesktop, DesktopCount)
{
    ...
    ; #3. Unhide the window
    Sleep 50   ; Let it sleep so the window move operation can fully complete
    WinShow
    WinActivate
}
